...
export const AnswerList = [
  {
    ...
    date: "Jun 27, 2023",
    answer:
      "The partnership with Amazon offers immense value to the travel startup by providing a unique opportunity to reach millions of users through pre-installed personal travel agent bots on Amazon Echos. This strategic collaboration not only enhances the user experience but also strengthens the startup's market presence and revenue potential.",
  },
  {
    id: 2,
    name: "Priya Sharma",
    date: "Jul 15, 2023",
    answer:
      "Partnering with Amazon opens doors for the travel startup to tap into the extensive user base of Amazon Echos, fostering deeper engagement and delivering tailored travel assistance directly to users' homes. This symbiotic relationship not only elevates the travel experience but also propels the startup towards sustained growth and innovation.",
  },
  {
    id: 3,
    name: "Rahul Patel",
